...
folderPath='C:\Users\sande\Documents\Imperial\matlab\Files\RB06\Digitise';
...
folderPath='C:\Users\sande\Documents\Imperial\matlab\Files\RB06\Intact\';
fileName=[folderPath,'Neutral.csv'];
...
LCdata='C:\Users\sande\Documents\Imperial\matlab\Files\LW40\Load cell data\ACL recon\Anterior.log';
t=importdata(LCdata);
loadcelldata=t.data(:,1);
% loadcelldata_test=loadcelldata(:,1)
offset=0.01;
coeff=800;
LCforce=coeff*loadcelldata+offset;

LCforce(round((numel(gTtti)/3)):numel(LCforce))=[];
%sync kinematics and load cell data
...
[ollie_nextpeakstart,ollie_rowpos,ollie_FlexExtValues,ollie_VarValValues,ollie_IntExtValues,ollie_AntPosValues,LCValues] = KeyData_v2(ollie_VarVal,ollie_IntExt,-ollie_FlexExt,ollie_AntPost,LCforce);
