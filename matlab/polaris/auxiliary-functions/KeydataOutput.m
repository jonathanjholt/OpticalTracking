function[]=KeydataOutput(Digitise_data, Kinematics_data,loadtype,LC_data,coeff,offset,LC_on,Output,injurylevel,Right,total_kneestates)
...
%% Load tracked points
kneestate=injurylevel;
fileName=Kinematics_data;
...
%% Getting Data from   Flexion Angles
if LC_on==true   
...
DataTable=Write2Excel(ollie_FlexExtValues,ollie_VarValValues,ollie_IntExtValues,ollie_AntPosValues,Output,kneestate,loadtype,total_kneestates,LCValues);
