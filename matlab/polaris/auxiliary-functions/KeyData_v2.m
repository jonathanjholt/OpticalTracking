function [nextpeakstart,rowpos,FlexExtValues,VarValValues,IntExtValues,AntPosValues,LCValues] = KeyData_v2(VarVal,IntExt,FlexExt,AntPost,LCdata)
...
for i=1:angles+1
    for j=1:3
        ...
        LCValues(i,j)=LCdata(LCrowpos(i,j));
    end
end
...
for i=1:angles+1
    ...
    LCValues(i,4) = (LCValues(i,1)+LCValues(i,2)+LCValues(i,3))/3;
end
